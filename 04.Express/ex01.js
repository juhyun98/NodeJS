...
- 단순(서버 생성, 요청, 응답) => 복잡(DB 연결, 라우팅 작업)

사용방법
(1) npm init -y
   - package.json 파일 생성
     => 현재 프로젝트에 관련 정보 및 설치 모듈 관리
...
- express.static(root)
  ...
  ** 정적인 파일을 클라이언트에게 상대 경로로로 바로 응답 X
...
app.get('/', (req, res) => {
    ...
    // Case 2. HTML 문서 응답
    // res.sendFile('C:/Users/Rei/Desktop/NodeJS/04.Express/public/ex01.html');
